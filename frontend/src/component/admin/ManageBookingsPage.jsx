...
const ManageBookingsPage = () => {
  ...
  const [currentPage, setCurrentPage] = useState(() => {
    const saved = parseInt(
      sessionStorage.getItem("manageBookings_currentPage"),
      10,
    );
  ...
  const getStatusLabel = (key) =>
    t(`bookings.status${key.charAt(0).toUpperCase() + key.slice(1)}`);
            ...
            <thead>
              ...
              >
                {[
                  ...
                  t("bookings.cols.checkin"),
                  t("bookings.cols.checkout"),
                  t("bookings.cols.nights"),
                  t("bookings.cols.guests"),
