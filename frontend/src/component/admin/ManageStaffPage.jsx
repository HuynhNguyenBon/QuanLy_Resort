...
const ManageStaffPage = () => {
  ...
  const handleCreateAccount = async () => {
    ...
    if (!email.trim()) {
      setAccountErr("Email không được để trống.");
      return;
    }
    if (!password) {
      setAccountErr("Mật khẩu không được để trống.");
      return;
    }
    if (password.length < 6) {
      setAccountErr("Mật khẩu phải có ít nhất 6 ký tự.");
      return;
    }
    if (password !== confirmPassword) {
      setAccountErr("Mật khẩu xác nhận không khớp.");
      return;
    }
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Ca làm việc, khu vực phụ trách..."
                  style={fieldStyle}
                  onFocus={(e) => (e.target.style.borderColor = "#0d9488")}
                  onBlur={(e) => (e.target.style.borderColor = "#e8ecef")}
                />
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                ℹ️ Tạo tài khoản đăng nhập hệ thống cho{" "}
                <strong>{accountModal.name}</strong>. Nhân viên dùng email + mật
                khẩu này để đăng nhập vào trang nhân viên.
              </div>
              <div>
