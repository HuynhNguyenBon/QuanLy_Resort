...
export default class ApiService {
  ...
  static async getRoomTranslation(roomId, lang = "en") {
    const response = await axios.get(
      `${this.BASE_URL}/translations/${roomId}/${lang}`,
    );
    return response.data;
  }
  ...
  static async getRoomTypes(lang) {
    const response = await axios.get(
      `${this.BASE_URL}/rooms/types?lang=${lang}`,
    );

    return response.data;
  }

  static async getAllRooms(lang) {
    const result = await axios.get(`${this.BASE_URL}/rooms/all?lang=${lang}`);
  ...
  static async checkRoomAvailability(roomId, checkInDate, checkOutDate) {
    const response = await axios.get(
      `${this.BASE_URL}/bookings/check-availability`,
      {
